defmodule RsoffersWeb.Offers.CertificateController do
  ...
  def new(conn, _params) do
    ...
    render(conn, "new.html", changeset: changeset, certificate: nil)
  end
  ...
  def create(conn, %{"certificate" => certificate_params}) do
    case Certificates.create_certificate(certificate_params) do
      {:ok, certificate} ->
        ...
        |> redirect(to: Routes.offers_certificate_path(conn, :show, certificate))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.offers_certificate_path(conn, :index))
  end
end
