defmodule Rsoffers.OfferStatus do
  @moduledoc """
  The OfferStatus context.
  """
  ...
  @doc """
  Returns the list of offer_status.

  ## Examples

      iex> list_offer_status()
      [%Status{}, ...]

  """
  def list_offer_status do
    Repo.all(Status)
  end
  ...
  def get_default_status() do
    query = from Status, where: true, limit: 1
    Repo.one!(query)
  end
end
