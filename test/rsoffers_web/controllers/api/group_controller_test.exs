defmodule RsoffersWeb.Api.GroupControllerTest do
  ...
  describe "new group" do
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.api_group_path(conn, :new))
  ...
  describe "create group" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert redirected_to(conn) == Routes.api_group_path(conn, :show, id)
  ...
  describe "edit group" do
    ...
    test "renders form for editing chosen group", %{conn: conn, group: group} do
      conn = get(conn, Routes.api_group_path(conn, :edit, group))
  ...
  describe "update group" do
    ...
    test "redirects when data is valid", %{conn: conn, group: group} do
      ...
      assert redirected_to(conn) == Routes.api_group_path(conn, :show, group)

      conn = get(conn, Routes.api_group_path(conn, :show, group))
  ...
  describe "delete group" do
    ...
    test "deletes chosen group", %{conn: conn, group: group} do
      ...
      assert redirected_to(conn) == Routes.api_group_path(conn, :index)
